		...
		<div id="content">
 			...
 			<div id="login_box">
				<form id="join" name="join" action="./Join" method="post">
					<input id="mode" name="mode" type="hidden" value="join" />
					<label class="block login_label" for="userId">ID</label>
					<input class="block login_input" id="userId" name="userId" type="text" />
					<label class="block login_label" for="password">Password</label>
					<input class="block login_input" id="password" name="password" type="password" />
					<label class="block login_label" for="re_password">Re-password</label>
					<input class="block login_input" id="re_password" name="re_password" type="password" />
					
					<input class="block button login_button" type="button" value="Join" onclick="javascript:join_submit();" />
				</form>
			</div>
